...
type
  TGlobal = class
    ...
    HModoProduccion: Integer;
    HClaveDocumento: string;
    HTokenUsuario: string;
    HTokenClave: string;
    HCertificadoArchivo: string;
    HCertificadoClave: string;
    HAccion: Integer;
    HArchivoNombre: string;
    HArchivoXMLFirmado: string;
    HArchivoXMLFirmar: string;

    DB_HaciendaDriver: string;
    DB_HaciendaTipo: Integer;
    DB_HaciendaServidor: string;
    DB_HaciendaBaseDatos: string;
    DB_HaciendaUsuario: string;
    DB_HaciendaClave: string;
    DB_HaciendaPuerto: Integer;
    DB_HaciendaVarios: string;
  end;
