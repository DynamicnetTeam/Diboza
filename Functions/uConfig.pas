...
begin
  try
    ...
    Global.EmpresaCodigo :=
      SettingsFile.ReadInteger('Sistema','IdEmpresa',0);
    Global.Instalado :=
...
procedure TConfig.EscribirIni_Empresa;
var
  SettingsFile: TIniFile;
  mArchivo: string;
begin
  try
    ...
    {$REGION 'Sistema'}
    SettingsFile.WriteInteger('Sistema','IdEmpresa', Global.EmpresaCodigo);
    {$ENDREGION}
