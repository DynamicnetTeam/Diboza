...
type
  TReptListadoVendedores01 = class(TForm)
    pnlTitulo: TRzPanel;
    pnlCampos: TRzPanel;
    GroupBox1: TGroupBox;
    cbOrden: TComboBoxEx;
...
var
  ReptListadoVendedores01: TReptListadoVendedores01;
...
var
  Forma01: TReptListadoVendedores01;

{$REGION 'Funciones Forma'}
procedure TReptListadoVendedores01.FormShow(Sender: TObject);
begin
  Forma01 := ReptListadoVendedores01;

  InicializarForma;
end;

procedure TReptListadoVendedores01.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
  FinalizarForma;
end;

procedure TReptListadoVendedores01.FormKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  KeyDownForma(Key, Shift);
end;

procedure TReptListadoVendedores01.btnAceptarClick(Sender: TObject);
begin
  Aceptar;
end;

procedure TReptListadoVendedores01.btnCancelarClick(Sender: TObject);
begin
  Cancelar;
end;
{$ENDREGION}
