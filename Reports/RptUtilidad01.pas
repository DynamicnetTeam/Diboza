...
var
  ReptUtilidad01: TReptUtilidad01;
...
uses
  ...
  uDL_TB_FACTURASCLIENTESENCABEZADO, udmLenguajes, FrmVerReporte01;

{$R *.dfm}

var
  Forma01: TReptUtilidad01;

{$REGION 'Funciones Forma'}
procedure TReptUtilidad01.FormShow(Sender: TObject);
begin
  Forma01 := ReptUtilidad01;

  InicializarForma;
end;

procedure TReptUtilidad01.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  FinalizarForma;
end;

procedure TReptUtilidad01.FormKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  KeyDownForma(Key, Shift);
end;

procedure TReptUtilidad01.btnAceptarClick(Sender: TObject);
begin
  Aceptar;
end;

procedure TReptUtilidad01.btnCancelarClick(Sender: TObject);
begin
  Cancelar;
end;
{$ENDREGION}
