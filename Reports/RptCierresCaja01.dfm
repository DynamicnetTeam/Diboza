object ReptCierresCaja01: TReptCierresCaja01
  Left = 0
  Top = 0
  ...
  object pnlCampos: TRzPanel
    ...
    object GroupBox2: TGroupBox
      ...
      object dtpFechaDesde: TDateTimePicker
        ...
        Width = 105
        Height = 24
        Date = 42906.010115706020000000
        Format = 'dd/MM/yyyy'
        Time = 42906.010115706020000000
        TabOrder = 1
      end
  ...
  object frxReport1: TfrxReport
    ...
    object Page1: TfrxReportPage
      ...
      object MasterData1: TfrxMasterData
        ...
        object frxDBDataset1FECHADE: TfrxMemoView
          AllowVectorExport = True
          ...
          Frame.Typ = []
          Memo.UTF8W = (
            '[frxDBDataset1."FECHADE"]')
          ParentFont = False
        end
        object frxDBDataset1MONTOINICIAL: TfrxMemoView
          AllowVectorExport = True
        ...
        object frxDBDataset1TOTALMONTOEFECTIVO: TfrxMemoView
          AllowVectorExport = True
          Left = 332.598640000000000000
          Width = 113.385826771653500000
          Height = 18.897650000000000000
          DataField = 'TOTALMONTOEFECTIVO'
          DataSet = frxDBDataset1
          DataSetName = 'frxDBDataset1'
          DisplayFormat.FormatStr = '%2.2n'
          DisplayFormat.Kind = fkNumeric
          ...
          HAlign = haRight
          Memo.UTF8W = (
            '[frxDBDataset1."TOTALMONTOEFECTIVO"]')
          ParentFont = False
        end
        object frxDBDataset1TOTALMONTOTARJETA: TfrxMemoView
          AllowVectorExport = True
          Left = 449.764070000000000000
          Width = 113.385826771653500000
          Height = 18.897650000000000000
          DataField = 'TOTALMONTOTARJETA'
          DataSet = frxDBDataset1
          DataSetName = 'frxDBDataset1'
          DisplayFormat.FormatStr = '%2.2n'
          DisplayFormat.Kind = fkNumeric
          ...
          HAlign = haRight
          Memo.UTF8W = (
            '[frxDBDataset1."TOTALMONTOTARJETA"]')
          ParentFont = False
        end
        object frxDBDataset1TOTALMONTOTRANSFERENCIA: TfrxMemoView
          AllowVectorExport = True
          Left = 566.929500000000000000
          Width = 113.385826771653500000
          Height = 18.897650000000000000
          DataField = 'TOTALMONTOTRANSFERENCIA'
          DataSet = frxDBDataset1
          DataSetName = 'frxDBDataset1'
          DisplayFormat.FormatStr = '%2.2n'
          DisplayFormat.Kind = fkNumeric
          ...
          HAlign = haRight
          Memo.UTF8W = (
            '[frxDBDataset1."TOTALMONTOTRANSFERENCIA"]')
          ParentFont = False
        end
        object frxDBDataset1TOTALMONTOCHEQUE: TfrxMemoView
          AllowVectorExport = True
          Left = 680.315400000000000000
          Width = 113.385826770000000000
          Height = 18.897650000000000000
          DataField = 'TOTALMONTOCHEQUE'
          DataSet = frxDBDataset1
          DataSetName = 'frxDBDataset1'
          DisplayFormat.FormatStr = '%2.2n'
          DisplayFormat.Kind = fkNumeric
          ...
          HAlign = haRight
          Memo.UTF8W = (
            '[frxDBDataset1."TOTALMONTOCHEQUE"]')
          ParentFont = False
        end
        object frxDBDataset1MONTOFINAL: TfrxMemoView
          AllowVectorExport = True
          Left = 793.701300000000000000
          Width = 113.385826770000000000
          Height = 18.897650000000000000
          DataField = 'MONTOFINAL'
          DataSet = frxDBDataset1
          DataSetName = 'frxDBDataset1'
          DisplayFormat.FormatStr = '%2.2n'
          DisplayFormat.Kind = fkNumeric
      ...
      object ReportSummary1: TfrxReportSummary
        ...
        object SysMemo1: TfrxSysMemoView
          ...
          HAlign = haRight
          Memo.UTF8W = (
            '[SUM(<frxDBDataset1."MONTOINICIAL">,MasterData1)]')
          ParentFont = False
        end
        object SysMemo2: TfrxSysMemoView
          ...
          HAlign = haRight
          Memo.UTF8W = (
            '[SUM(<frxDBDataset1."TOTALMONTOEFECTIVO">,MasterData1)]')
          ParentFont = False
        end
        object SysMemo3: TfrxSysMemoView
          ...
          HAlign = haRight
          Memo.UTF8W = (
            '[SUM(<frxDBDataset1."TOTALMONTOTARJETA">,MasterData1)]')
          ParentFont = False
        end
        object SysMemo4: TfrxSysMemoView
          ...
          HAlign = haRight
          Memo.UTF8W = (
            '[SUM(<frxDBDataset1."TOTALMONTOTRANSFERENCIA">,MasterData1)]')
          ParentFont = False
        end
        object SysMemo5: TfrxSysMemoView
          ...
          HAlign = haRight
          Memo.UTF8W = (
            '[SUM(<frxDBDataset1."TOTALMONTOCHEQUE">,MasterData1)]')
          ParentFont = False
        end
        object SysMemo6: TfrxSysMemoView
          ...
          HAlign = haRight
          Memo.UTF8W = (
            '[SUM(<frxDBDataset1."MONTOFINAL">,MasterData1)]')
          ParentFont = False
        end
      end
    end
  ...
  object FDMemTable1: TFDMemTable
    FieldDefs = <
      ...
      item
        Name = 'TOTALMONTOEFECTIVO'
        DataType = ftFloat
      end
      item
        Name = 'TOTALMONTOTARJETA'
        DataType = ftFloat
      end
      item
        Name = 'TOTALMONTOTRANSFERENCIA'
        DataType = ftFloat
      end
      item
        Name = 'TOTALMONTOCHEQUE'
        DataType = ftFloat
      end
      item
        Name = 'MONTOFINAL'
