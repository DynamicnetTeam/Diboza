...
begin
  ...
  begin
    ...
    try
      ...
      mDL_TB_FACTURASCLIENTESENCABEZADO.Estadistico(
        mWhere.Text, mDL_TB_FACTURASCLIENTESENCABEZADO.DatasetEstadistico,
        _Resultado, _ErrorM);
      mWhere.Free;
      mOrderBy.Free;
      if _Resultado = -1 then
        raise Exception.Create('');
      with mDL_TB_FACTURASCLIENTESENCABEZADO.DatasetEstadistico do
      begin
        First;
        while not Eof do
        begin
