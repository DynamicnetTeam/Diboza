...
type
  TReptRecibosApartados01 = class(TForm)
    pnlTitulo: TRzPanel;
    pnlCampos: TRzPanel;
    GroupBox1: TGroupBox;
    cbOrden: TComboBoxEx;
...
var
  ReptRecibosApartados01: TReptRecibosApartados01;
...
uses
  uSistema, ufunciones, uDL_TB_RECIBOSAPARTADOSENCABEZADO, BS_DBConexion, DL_DBGeneral,
  uDL_TB_CLIENTES, udmLenguajes, FrmVerReporte01;

{$R *.dfm}

var
  Forma01: TReptRecibosApartados01;

{$REGION 'Funciones Forma'}
procedure TReptRecibosApartados01.FormShow(Sender: TObject);
begin
  Forma01 := ReptRecibosApartados01;

  InicializarForma;
end;

procedure TReptRecibosApartados01.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
  FinalizarForma;
end;

procedure TReptRecibosApartados01.FormKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  KeyDownForma(Key, Shift);
end;

procedure TReptRecibosApartados01.btnAceptarClick(Sender: TObject);
begin
  Aceptar;
end;

procedure TReptRecibosApartados01.btnCancelarClick(Sender: TObject);
begin
  Cancelar;
end;
{$ENDREGION}
...
begin
  ...
  begin
    ...
    try
      ...
      mDL_TB_RECIBOSAPARTADOSENCABEZADO.Consultar(_Resultado, _ErrorM,
