...
type
  TReptFacturasClientes01 = class(TForm)
    pnlTitulo: TRzPanel;
    pnlCampos: TRzPanel;
    GroupBox1: TGroupBox;
    cbOrden: TComboBoxEx;
...
var
  ReptFacturasClientes01: TReptFacturasClientes01;
...
var
  Forma01: TReptFacturasClientes01;

{$REGION 'Funciones Forma'}
procedure TReptFacturasClientes01.FormShow(Sender: TObject);
begin
  Forma01 := ReptFacturasClientes01;

  InicializarForma;
end;

procedure TReptFacturasClientes01.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
  FinalizarForma;
end;

procedure TReptFacturasClientes01.FormKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  KeyDownForma(Key, Shift);
end;

procedure TReptFacturasClientes01.btnAceptarClick(Sender: TObject);
begin
  Aceptar;
end;

procedure TReptFacturasClientes01.btnCancelarClick(Sender: TObject);
begin
  Cancelar;
end;
{$ENDREGION}
