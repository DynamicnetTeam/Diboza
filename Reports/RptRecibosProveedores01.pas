...
type
  TReptRecibosProveedores01 = class(TForm)
    pnlTitulo: TRzPanel;
    pnlCampos: TRzPanel;
    GroupBox1: TGroupBox;
    cbOrden: TComboBoxEx;
...
var
  ReptRecibosProveedores01: TReptRecibosProveedores01;
...
uses
  uSistema, ufunciones, uDL_TB_RECIBOSPROVEEDORESENCABEZADO, BS_DBConexion, DL_DBGeneral,
  uDL_TB_PROVEEDORES, udmLenguajes, FrmVerReporte01;

{$R *.dfm}

var
  Forma01: TReptRecibosProveedores01;

{$REGION 'Funciones Forma'}
procedure TReptRecibosProveedores01.FormShow(Sender: TObject);
begin
  Forma01 := ReptRecibosProveedores01;

  InicializarForma;
end;

procedure TReptRecibosProveedores01.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
  FinalizarForma;
end;

procedure TReptRecibosProveedores01.FormKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  KeyDownForma(Key, Shift);
end;

procedure TReptRecibosProveedores01.btnAceptarClick(Sender: TObject);
begin
  Aceptar;
end;

procedure TReptRecibosProveedores01.btnCancelarClick(Sender: TObject);
begin
  Cancelar;
end;
{$ENDREGION}
...
procedure Construir_Reporte;
var
  mDL_TB_RECIBOSPROVEEDORESENCABEZADO: TDL_TB_RECIBOSPROVEEDORESENCABEZADO;
...
begin
  ...
  begin
    ...
    try
      ...
      mDL_TB_RECIBOSPROVEEDORESENCABEZADO := TDL_TB_RECIBOSPROVEEDORESENCABEZADO.Create;
      mDL_TB_RECIBOSPROVEEDORESENCABEZADO.Consultar(_Resultado, _ErrorM,
        mWhere.Text, mOrderBy.Text);
      mWhere.Free;
      mOrderBy.Free;
      if _Resultado = -1 then
        raise Exception.Create('');
      with mDL_TB_RECIBOSPROVEEDORESENCABEZADO.Dataset do
      begin
        First;
        while not Eof do
        begin
      ...
      mDL_TB_RECIBOSPROVEEDORESENCABEZADO.Destroy;
