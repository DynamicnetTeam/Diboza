...
type
  TReptNotasCredito01 = class(TForm)
    pnlTitulo: TRzPanel;
    pnlCampos: TRzPanel;
    GroupBox1: TGroupBox;
    cbOrden: TComboBoxEx;
...
var
  ReptNotasCredito01: TReptNotasCredito01;
...
uses
  uSistema, ufunciones, uDL_TB_NOTASCREDITOENCABEZADO, BS_DBConexion, DL_DBGeneral,
  uDL_TB_CLIENTES, udmLenguajes, FrmVerReporte01;

{$R *.dfm}

var
  Forma01: TReptNotasCredito01;

{$REGION 'Funciones Forma'}
procedure TReptNotasCredito01.FormShow(Sender: TObject);
begin
  Forma01 := ReptNotasCredito01;

  InicializarForma;
end;

procedure TReptNotasCredito01.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
  FinalizarForma;
end;

procedure TReptNotasCredito01.FormKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  KeyDownForma(Key, Shift);
end;

procedure TReptNotasCredito01.btnAceptarClick(Sender: TObject);
begin
  Aceptar;
end;

procedure TReptNotasCredito01.btnCancelarClick(Sender: TObject);
begin
  Cancelar;
end;
{$ENDREGION}
...
begin
  ...
  begin
    ...
    try
      ...
      mDL_TB_NOTASCREDITOENCABEZADO.Consultar(_Resultado, _ErrorM,
      ...
      begin
        ...
        begin
          ...
          FDMemTable1.FieldByName('NumeroDocumento').AsInteger :=
