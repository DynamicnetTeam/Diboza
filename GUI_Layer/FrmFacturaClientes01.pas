    ...
    try
     ...
     // mClave := GetClave(dtpFecha.Date, mConsecutivo, '1', mIdentificacion, '99999999');
      ...
      dmObjects.DB_Hacienda_Insertar(
        ...
        mPlazoCredito, mMedioPago, _DL_TB_FACTURASDETALLEActual.Dataset,
        dmObjects.FDQuery1, Global.IdSucursal, Global.IdTerminal,
        mNumero, mDL_TB_CLIENTES.Dataset, _DL_TB_FACTURASDETALLEActual.Dataset,
        Global.PathTemp, Global.PathAplicacion, 'FE', Global.EmpresaCodigo,
        _Resultado, _ErrorM);
