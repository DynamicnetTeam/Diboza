...
uses
  uSistema, ufunciones, uDL_TB_Familias, BS_DBConexion,
  FrmFamilias01, FrmMensaje_Espera01, udmLenguajes;
...
procedure TFormMantenimientoFamilias01.btnInsertarClick(Sender: TObject);
begin
  Insertar;
end;

procedure TFormMantenimientoFamilias01.btnModificarClick(Sender: TObject);
begin
  Modificar(lvLista1);
end;

procedure TFormMantenimientoFamilias01.btnEliminarClick(Sender: TObject);
begin
  Eliminar(lvLista1);
end;

procedure TFormMantenimientoFamilias01.btnRefrescarClick(Sender: TObject);
begin
  Refrescar(lvLista1);
end;

procedure TFormMantenimientoFamilias01.btnCerrarClick(Sender: TObject);
begin
  Cerrar;
end;

procedure TFormMantenimientoFamilias01.edtBuscar_NombreInvokeSearch(
  Sender: TObject);
begin
...
begin
  ...
  begin
    ...
    FormFamilias01._Opcion := 1;
    FormFamilias01.ShowModal;
    if FormFamilias01.Tag = 1 then
      btnRefrescar.Click;
...
begin
  ...
  begin
    ...
    try
      ...
      LlenarlvLista1(lv, mBS_Familias.Dataset);
