unit FrmMantenimientoCuentas01;
...
type
  TFormMantenimientoCuentas01 = class(TForm)
    pnlTitulo: TRzPanel;
...
var
  FormMantenimientoCuentas01: TFormMantenimientoCuentas01;
...
uses
  ...
  FrmCuentas01, FrmMensaje_Espera01, udmLenguajes;
...
procedure TFormMantenimientoCuentas01.FormShow(Sender: TObject);
begin
...
procedure TFormMantenimientoCuentas01.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
  FinalizarForma;
end;

procedure TFormMantenimientoCuentas01.FormKeyDown(Sender: TObject;
  var Key: Word; Shift: TShiftState);
begin
  KeyDownForma(Key, Shift);
end;

procedure TFormMantenimientoCuentas01.chkTodoLista1Click(Sender: TObject);
begin
  MDLista_Todos(lvLista1, chkTodoLista1);
end;

procedure TFormMantenimientoCuentas01.btnInsertarClick(Sender: TObject);
begin
  Insertar;
end;

procedure TFormMantenimientoCuentas01.btnModificarClick(Sender: TObject);
begin
  Modificar(lvLista1);
end;

procedure TFormMantenimientoCuentas01.btnEliminarClick(Sender: TObject);
begin
  Eliminar(lvLista1);
end;

procedure TFormMantenimientoCuentas01.btnRefrescarClick(Sender: TObject);
begin
  Refrescar(lvLista1);
end;

procedure TFormMantenimientoCuentas01.btnCerrarClick(Sender: TObject);
begin
  Cerrar;
end;

procedure TFormMantenimientoCuentas01.edtBuscar_NombreInvokeSearch(
  Sender: TObject);
begin
...
begin
  ...
  begin
    ...
    FormCuentas01._Opcion := 1;
    FormCuentas01.ShowModal;
    if FormCuentas01.Tag = 1 then
      btnRefrescar.Click;
...
begin
  ...
  begin
    ...
    begin
      ...
      if mId > 0 then
      begin
        FormCuentas01._Id := mId;
        FormCuentas01._Opcion := 2;
        FormCuentas01.ShowModal;
        if FormCuentas01.Tag = 1 then
          btnRefrescar.Click;
      end;
      ...
      begin
        ...
        begin
          ...
          begin
            ...
            mDL_TB_Cuentas.Eliminar('Id=' + IntToStr(mIdProducto), _Resultado, _ErrorM);
...
begin
  ...
  begin
    ...
    try
      ...
      mDL_TB_Cuentas := Clase_Tipo1.Create;
      mWhere := TStringList.Create;
      mWhere.Clear;
      mWhere.Add('A.Editable=1');
      mOrderBy := TStringList.Create;
      mOrderBy.Clear;
      mOrderBy.Add('A.idTipo,A.codigo');
      mDL_TB_Cuentas.Consultar(_Resultado, _ErrorM, mWhere.Text,
        mOrderBy.Text);
      mWhere.Free;
      mOrderBy.Free;
      if _Resultado = -1 then
      ...
      LlenarlvLista1(lv, mDL_TB_Cuentas.Dataset);
      mDL_TB_Cuentas.Destroy;
    ...
    begin
      ...
      begin
        ...
        begin
          ...
          SubItems.Add(
            FieldByName('CuentaPadreNombre').AsString);
          SubItems.Add(
...
begin
  ...
  begin
    ...
    try
      ...
      mDL_TB_Cuentas.Eliminar(mWhere.Text, _Resultado, _ErrorM);
      mWhere.Free;
      if _Resultado = -1 then
        raise Exception.Create('');
      mDL_TB_Cuentas.Destroy;
