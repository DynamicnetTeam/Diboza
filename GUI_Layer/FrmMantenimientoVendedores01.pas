unit FrmMantenimientoVendedores01;
...
type
  TFormMantenimientoVendedores01 = class(TForm)
    pnlTitulo: TRzPanel;
...
var
  FormMantenimientoVendedores01: TFormMantenimientoVendedores01;
...
uses
  uSistema, ufunciones, uDL_TB_VENDEDORES, BS_DBConexion,
  FrmVendedores01, FrmMensaje_Espera01, uDL_TB_VENDEDORESCLIENTES,
  udmLenguajes;
...
var
  Forma01: TFormMantenimientoVendedores01;

{$REGION 'Funciones Forma'}
procedure TFormMantenimientoVendedores01.FormShow(Sender: TObject);
begin
  Forma01 := FormMantenimientoVendedores01;

  InicializarForma;
end;

procedure TFormMantenimientoVendedores01.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
  FinalizarForma;
end;

procedure TFormMantenimientoVendedores01.FormKeyDown(Sender: TObject;
  var Key: Word; Shift: TShiftState);
begin
  KeyDownForma(Key, Shift);
end;

procedure TFormMantenimientoVendedores01.chkTodoLista1Click(Sender: TObject);
begin
  MDLista_Todos(lvLista1, chkTodoLista1);
end;

procedure TFormMantenimientoVendedores01.btnInsertarClick(Sender: TObject);
begin
  Insertar;
end;

procedure TFormMantenimientoVendedores01.btnModificarClick(Sender: TObject);
begin
  Modificar(lvLista1);
end;

procedure TFormMantenimientoVendedores01.btnEliminarClick(Sender: TObject);
begin
  Eliminar(lvLista1);
end;

procedure TFormMantenimientoVendedores01.btnRefrescarClick(Sender: TObject);
begin
  Refrescar(lvLista1);
end;

procedure TFormMantenimientoVendedores01.btnCerrarClick(Sender: TObject);
begin
  Cerrar;
end;

procedure TFormMantenimientoVendedores01.edtBuscar_NombreInvokeSearch(
  Sender: TObject);
begin
...
begin
  ...
  begin
    ...
    FormVendedores01._Opcion := 1;
    FormVendedores01.ShowModal;
    if FormVendedores01.Tag = 1 then
      btnRefrescar.Click;
...
begin
  ...
  begin
    ...
    begin
      ...
      if mId > 0 then
      begin
        FormVendedores01._Id := mId;
        FormVendedores01._Opcion := 2;
        FormVendedores01.ShowModal;
        if FormVendedores01.Tag = 1 then
          btnRefrescar.Click;
      end;
...
begin
  ...
  begin
    ...
    try
      ...
      LlenarlvLista1(lv, mBS_Vendedores.Dataset);
...
begin
  ...
  begin
    ...
    try
      ...
      mBS_Vendedores.Eliminar(mWhere.Text, _Resultado, _ErrorM);
      mWhere.Free;
      if _Resultado = -1 then
        raise Exception.Create('');
      mBS_Vendedores.Destroy;
      ...
      mWhere := TStringList.Create;
      mWhere.Add('IDVENDEDOR = ' + IntToStr(pId));
      mDL_TB_VENDEDORESCLIENTES := TDL_TB_VENDEDORESCLIENTES.Create;
      mDL_TB_VENDEDORESCLIENTES.Eliminar(mWhere.Text, _Resultado, _ErrorM);
      mWhere.Free;
      if _Resultado = -1 then
        raise Exception.Create('');
      mDL_TB_VENDEDORESCLIENTES.Destroy;
