object FormMantenimientoUsuarios01: TFormMantenimientoUsuarios01
  Left = 0
  Top = 0
  Caption = 'Usuarios'
  ClientHeight = 362
  ...
  object pnlFiltro: TRzPanel
    ...
    object edtBuscar_Usuario: TRzButtonEdit
      Left = 72
      Top = 8
      Width = 150
      Height = 24
      ...
      AltBtnWidth = 15
      ButtonWidth = 15
      OnButtonClick = edtBuscar_UsuarioInvokeSearch
    end
