object FormRecibosProveedores01: TFormRecibosProveedores01
  Left = 0
  Top = 0
  Caption = 'Recibos'
  ClientHeight = 371
  ...
  object pnlCampos: TRzPanel
    ...
    object pnlDetalle: TRzPanel
      ...
      object pnlCodigoProducto: TRzPanel
        ...
        object cbDocumentos: TComboBoxEx
          Left = 1
          Top = 17
          Width = 198
          Height = 25
          ...
          TabOrder = 0
          Text = 'cbDocumentos'
          OnChange = cbDocumentosChange
          OnDropDown = cbDocumentosDropDown
        end
      end
