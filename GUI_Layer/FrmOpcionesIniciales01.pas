  ...
  begin
    ...
    try
      ...
      begin
        ...
        Append;
        FieldByName('DESCRIPCION').Tag := 1;
        FieldByName('DESCRIPCION').AsString := 'Factura de Crédito';
        FieldByName('PLANTILLA').Tag := 1;
        FieldByName('PLANTILLA').AsString :=
          mPlantilla;
        Post;
      ...
      begin
        ...
        Append;
        FieldByName('DESCRIPCION').Tag := 1;
        FieldByName('DESCRIPCION').AsString := 'Proforma de Crédito';
        FieldByName('PLANTILLA').Tag := 1;
        FieldByName('PLANTILLA').AsString :=
          mPlantilla;
        Post;
      ...
      mDL_TB_EMPRESAS.Modificar('Id=1', _Resultado, _ErrorM);
...
begin
  ...
  begin
    ...
    cbPapelSize.Items.AddObject('Tamaño 56mm', TObject(1));
    cbPapelSize.Items.AddObject('Tamaño 76mm', TObject(2));
    cbPapelSize.Items.AddObject('Tamaño 210mm', TObject(3));
