object FormMantenimientoFacturasClientes01: TFormMantenimientoFacturasClientes01
  Left = 0
  Top = 0
  Caption = 'Facturas'
  ClientHeight = 362
  ...
  object pnlFiltro: TRzPanel
    ...
    object edtBuscar_Numero: TRzButtonEdit
      Left = 64
      Top = 9
      Width = 110
      Height = 24
      ...
      AltBtnWidth = 15
      ButtonWidth = 15
      OnButtonClick = edtBuscar_NumeroInvokeSearch
    end
    object dtpFechaDesde: TRzDateTimeEdit
      Left = 226
      Top = 9
      Width = 121
      Height = 24
    ...
    object dtpFechaHasta: TRzDateTimeEdit
      Left = 395
      Top = 9
      Width = 121
      Height = 24
    ...
    object chkAplicarRangoFecha: TRzCheckBox
      Left = 544
      Top = 14
      Width = 19
      Height = 15
  ...
  object lvLista1: TRzListView
    ...
    Columns = <
      ...
      item
        Caption = 'CodigoEstado'
        MaxWidth = 1
        Width = 0
      end
      item
        Caption = 'CodigoFormaPago'
        MaxWidth = 1
        Width = 0
      end
      item
    ...
    TabOrder = 4
    ViewStyle = vsReport
    OnCustomDrawItem = lvLista1CustomDrawItem
  end
end
