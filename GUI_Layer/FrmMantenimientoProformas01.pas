unit FrmMantenimientoProformas01;
...
type
  TFormMantenimientoProformas01 = class(TForm)
    pnlTitulo: TRzPanel;
...
var
  FormMantenimientoProformas01: TFormMantenimientoProformas01;
...
uses
  ...
  FrmProformas01, FrmMensaje_Espera01, udmLenguajes;
...
var
  Forma01: TFormMantenimientoProformas01;

{$REGION 'Funciones Forma'}
procedure TFormMantenimientoProformas01.FormShow(Sender: TObject);
begin
  Forma01 := FormMantenimientoProformas01;

  InicializarForma;
end;

procedure TFormMantenimientoProformas01.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
  FinalizarForma;
end;

procedure TFormMantenimientoProformas01.FormKeyDown(Sender: TObject;
  var Key: Word; Shift: TShiftState);
begin
  KeyDownForma(Key, Shift);
end;

procedure TFormMantenimientoProformas01.btnInsertarClick(Sender: TObject);
begin
  Insertar;
end;

procedure TFormMantenimientoProformas01.btnModificarClick(Sender: TObject);
begin
  Modificar(lvLista1);
end;

procedure TFormMantenimientoProformas01.btnRefrescarClick(Sender: TObject);
begin
  Refrescar(lvLista1);
end;

procedure TFormMantenimientoProformas01.btnCerrarClick(Sender: TObject);
begin
  Cerrar;
end;

procedure TFormMantenimientoProformas01.edtBuscar_NumeroInvokeSearch(
  Sender: TObject);
begin
  Buscar_Numero(edtBuscar_Numero.Text, lvLista1);
end;

procedure TFormMantenimientoProformas01.lvLista1CustomDrawItem(
  ...
  begin
    ...
    begin
      ...
      if (mId > 0) and (mEstado > 0) and (mFormaPago > 0) and
        (mDocumento > 0) then
      begin
        FormProformas01._IdEstado := mEstado;
        FormProformas01._IdFormaPago := mFormaPago;
        FormProformas01._IdDocumento := mId;
        FormProformas01._Numero := mDocumento;
        FormProformas01.WindowState := wsMaximized;
        FormProformas01.ShowModal;
        btnRefrescar.Click;
      end;
...
procedure Refrescar(lv: TRzListView);
var
  mBS_ProformasEncabezado: Clase_Tipo1;
...
begin
  ...
  begin
    ...
    try
      ...
      mBS_ProformasEncabezado := Clase_Tipo1.Create;
      ...
      mBS_ProformasEncabezado.Consultar(_Resultado, _ErrorM, mWhere.Text,
        mOrderBy.Text);
      mWhere.Free;
      mOrderBy.Free;
      if _Resultado = -1 then
      ...
      LlenarlvLista1(lv, mBS_ProformasEncabezado.Dataset);
      mBS_ProformasEncabezado.Destroy;
