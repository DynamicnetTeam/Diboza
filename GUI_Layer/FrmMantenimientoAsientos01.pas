...
uses
  ...
  FrmAsientos01, FrmMensaje_Espera01, udmLenguajes;
...
procedure TFormMantenimientoAsientos01.chkTodoLista1Click(Sender: TObject);
begin
  MDLista_Todos(lvLista1, chkTodoLista1);
end;

procedure TFormMantenimientoAsientos01.btnInsertarClick(Sender: TObject);
begin
  Insertar;
end;

procedure TFormMantenimientoAsientos01.btnModificarClick(Sender: TObject);
begin
  Modificar(lvLista1);
end;

procedure TFormMantenimientoAsientos01.btnEliminarClick(Sender: TObject);
begin
  Eliminar(lvLista1);
end;

procedure TFormMantenimientoAsientos01.btnRefrescarClick(Sender: TObject);
begin
  Refrescar(lvLista1);
end;

procedure TFormMantenimientoAsientos01.btnCerrarClick(Sender: TObject);
begin
  Cerrar;
end;
{$ENDREGION}
...
begin
  ...
  begin
    ...
    FormAsientos01._Opcion := 1;
    FormAsientos01.ShowModal;
    if FormAsientos01.Tag = 1 then
      btnRefrescar.Click;
...
begin
  ...
  begin
    ...
    begin
      ...
      if mId > 0 then
      begin
        FormAsientos01._Id := mId;
        FormAsientos01._Opcion := 2;
        FormAsientos01.ShowModal;
        if FormAsientos01.Tag = 1 then
          btnRefrescar.Click;
      end;
