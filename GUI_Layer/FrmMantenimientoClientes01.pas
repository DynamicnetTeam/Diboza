unit FrmMantenimientoClientes01;
...
type
  TFormMantenimientoClientes01 = class(TForm)
    pnlTitulo: TRzPanel;
...
var
  FormMantenimientoClientes01: TFormMantenimientoClientes01;
...
var
  Forma01: TFormMantenimientoClientes01;

{$REGION 'Funciones Forma'}
procedure TFormMantenimientoClientes01.FormShow(Sender: TObject);
begin
  Forma01 := FormMantenimientoClientes01;

  InicializarForma;
end;

procedure TFormMantenimientoClientes01.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
  FinalizarForma;
end;

procedure TFormMantenimientoClientes01.FormKeyDown(Sender: TObject;
  var Key: Word; Shift: TShiftState);
begin
  KeyDownForma(Key, Shift);
end;

procedure TFormMantenimientoClientes01.chkTodoLista1Click(Sender: TObject);
begin
  MDLista_Todos(lvLista1, chkTodoLista1);
end;

procedure TFormMantenimientoClientes01.btnInsertarClick(Sender: TObject);
begin
  Insertar;
end;

procedure TFormMantenimientoClientes01.btnModificarClick(Sender: TObject);
begin
  Modificar(lvLista1);
end;

procedure TFormMantenimientoClientes01.btnEliminarClick(Sender: TObject);
begin
  Eliminar(lvLista1);
end;

procedure TFormMantenimientoClientes01.btnRefrescarClick(Sender: TObject);
begin
  Refrescar(lvLista1);
end;

procedure TFormMantenimientoClientes01.btnCerrarClick(Sender: TObject);
begin
  Cerrar;
end;

procedure TFormMantenimientoClientes01.edtBuscar_NombreInvokeSearch(
  Sender: TObject);
begin
  Buscar_Nombre(edtBuscar_Nombre.Text, lvLista1);
end;

procedure TFormMantenimientoClientes01.edtBuscar_CodigoInvokeSearch(
  Sender: TObject);
begin
...
begin
  ...
  begin
    ...
    FormClientes01._Opcion := 1;
    FormClientes01.ShowModal;
    if FormClientes01.Tag = 1 then
      btnRefrescar.Click;
...
begin
  ...
  begin
    ...
    begin
      ...
      if mId > 0 then
      begin
        FormClientes01._Id := mId;
        FormClientes01._Opcion := 2;
        FormClientes01.ShowModal;
        if FormClientes01.Tag = 1 then
          btnRefrescar.Click;
      end;
