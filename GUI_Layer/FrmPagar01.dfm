object FormPagar01: TFormPagar01
  Left = 0
  Top = 0
  ...
  object pnlCampos: TRzPanel
    ...
    object pnlEfectivo: TRzPanel
      ...
      BorderOuter = fsFlat
      TabOrder = 1
      object pnlEfectivoTitulo: TRzPanel
        Left = 1
        Top = 1
        Width = 804
        Height = 20
      ...
      object edtEfectivo: TCurrencyEdit
        ...
        ParentFont = False
        TabOrder = 1
        OnChange = edtEfectivoChange
        ExplicitHeight = 40
      end
    end
    object pnlOtros: TRzPanel
      Left = 1
      Top = 116
      Width = 806
      Height = 73
    ...
    object pnlCredito: TRzPanel
      ...
      object pnlCreditoTitulo: TRzPanel
        Left = 1
        Top = 1
        Width = 804
        Height = 20
