unit FrmMantenimientoRecibosProveedores01;
...
type
  TFormMantenimientoRecibosProveedores01 = class(TForm)
    pnlTitulo: TRzPanel;
...
var
  FormMantenimientoRecibosProveedores01: TFormMantenimientoRecibosProveedores01;
...
uses
  ...
  FrmRecibosProveedores01, FrmMensaje_Espera01, udmLenguajes;
...
var
  Forma01: TFormMantenimientoRecibosProveedores01;

{$REGION 'Funciones Forma'}
procedure TFormMantenimientoRecibosProveedores01.FormShow(Sender: TObject);
begin
  Forma01 := FormMantenimientoRecibosProveedores01;

  InicializarForma;
end;

procedure TFormMantenimientoRecibosProveedores01.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
  FinalizarForma;
end;

procedure TFormMantenimientoRecibosProveedores01.FormKeyDown(Sender: TObject;
  var Key: Word; Shift: TShiftState);
begin
  KeyDownForma(Key, Shift);
end;

procedure TFormMantenimientoRecibosProveedores01.btnInsertarClick(
  Sender: TObject);
begin
  Insertar;
end;

procedure TFormMantenimientoRecibosProveedores01.btnModificarClick(
  Sender: TObject);
begin
  Modificar(lvLista1);
end;

procedure TFormMantenimientoRecibosProveedores01.btnRefrescarClick(
  Sender: TObject);
begin
  Refrescar(lvLista1);
end;

procedure TFormMantenimientoRecibosProveedores01.btnCerrarClick(
  Sender: TObject);
begin
  Cerrar;
end;

procedure TFormMantenimientoRecibosProveedores01.edtBuscar_NumeroInvokeSearch(
  Sender: TObject);
begin
  Buscar_Numero(edtBuscar_Numero.Text, lvLista1);
end;

procedure TFormMantenimientoRecibosProveedores01.lvLista1CustomDrawItem(
...
begin
  ...
  begin
    ...
    FormRecibosProveedores01._IdEstado := 1;
    FormRecibosProveedores01._IdFormaPago := 0;
    FormRecibosProveedores01._IdDocumento := 0;
    FormRecibosProveedores01._Numero := 0;
    FormRecibosProveedores01.WindowState := wsMaximized;
    FormRecibosProveedores01.ShowModal;
    btnRefrescar.Click;
  ...
  begin
    ...
    begin
      ...
      if (mId > 0) and (mEstado > 0) and
        (mDocumento > 0) then
      begin
        FormRecibosProveedores01._IdEstado := mEstado;
        FormRecibosProveedores01._IdFormaPago := mFormaPago;
        FormRecibosProveedores01._IdDocumento := mId;
        FormRecibosProveedores01._Numero := mDocumento;
        FormRecibosProveedores01.WindowState := wsMaximized;
        FormRecibosProveedores01.ShowModal;
        btnRefrescar.Click;
      end;
