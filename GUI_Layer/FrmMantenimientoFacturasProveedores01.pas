unit FrmMantenimientoFacturasProveedores01;
...
type
  TFormMantenimientoFacturasProveedores01 = class(TForm)
    pnlTitulo: TRzPanel;
...
var
  FormMantenimientoFacturasProveedores01: TFormMantenimientoFacturasProveedores01;
...
uses
  ...
  FrmFacturasProveedores01, FrmMensaje_Espera01, udmLenguajes;
...
var
  Forma01: TFormMantenimientoFacturasProveedores01;

{$REGION 'Funciones Forma'}
procedure TFormMantenimientoFacturasProveedores01.FormShow(Sender: TObject);
begin
  Forma01 := FormMantenimientoFacturasProveedores01;

  InicializarForma;
end;

procedure TFormMantenimientoFacturasProveedores01.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
  FinalizarForma;
end;

procedure TFormMantenimientoFacturasProveedores01.FormKeyDown(Sender: TObject;
  var Key: Word; Shift: TShiftState);
begin
  KeyDownForma(Key, Shift);
end;

procedure TFormMantenimientoFacturasProveedores01.btnInsertarClick(
  Sender: TObject);
begin
  Insertar;
end;

procedure TFormMantenimientoFacturasProveedores01.btnModificarClick(
  Sender: TObject);
begin
  Modificar(lvLista1);
end;

procedure TFormMantenimientoFacturasProveedores01.btnRefrescarClick(
  Sender: TObject);
begin
  Refrescar(lvLista1);
end;

procedure TFormMantenimientoFacturasProveedores01.btnCerrarClick(
  Sender: TObject);
begin
  Cerrar;
end;

procedure TFormMantenimientoFacturasProveedores01.edtBuscar_NumeroInvokeSearch(
  Sender: TObject);
begin
  Buscar_Numero(edtBuscar_Numero.Text, lvLista1);
end;

procedure TFormMantenimientoFacturasProveedores01.lvLista1CustomDrawItem(
  ...
  begin
    ...
    begin
      ...
      if (mId > 0) and (mEstado > 0) and (mFormaPago > 0) and
        (mDocumento > 0) then
      begin
        FormFacturasProveedores01._IdEstado := mEstado;
        FormFacturasProveedores01._IdFormaPago := mFormaPago;
        FormFacturasProveedores01._IdDocumento := mId;
        FormFacturasProveedores01._Numero := mDocumento;
        FormFacturasProveedores01.WindowState := wsMaximized;
        FormFacturasProveedores01.ShowModal;
        btnRefrescar.Click;
      end;
...
procedure Refrescar(lv: TRzListView);
var
  mBS_EntradasEncabezado: Clase_Tipo1;
...
begin
  ...
  begin
    ...
    try
      ...
      mBS_EntradasEncabezado := Clase_Tipo1.Create;
      ...
      mBS_EntradasEncabezado.Consultar(_Resultado, _ErrorM, mWhere.Text,
        mOrderBy.Text);
      mWhere.Free;
      mOrderBy.Free;
      if _Resultado = -1 then
      ...
      LlenarlvLista1(lv, mBS_EntradasEncabezado.Dataset);
      mBS_EntradasEncabezado.Destroy;
