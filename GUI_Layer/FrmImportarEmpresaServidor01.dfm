object FormImportarEmpresaServidor01: TFormImportarEmpresaServidor01
  Left = 0
  Top = 0
  ...
  object cbImpoartar: TComboBoxEx
    Left = 88
    Top = 31
    Width = 329
    Height = 22
  ...
  object RzGroupBox1: TRzGroupBox
    ...
    Width = 401
    Height = 64
    Caption = 'Selecionar Sucursal / Terminal'
    ShowCheckBox = True
    TabOrder = 3
    TabStop = True
    OnCheckBoxClick = RzGroupBox1CheckBoxClick
    ...
    object cbSucursal: TComboBoxEx
      ...
      TabOrder = 0
      Text = 'cbSucursal'
      OnChange = cbSucursalChange
    end
    object cbTerminal: TComboBoxEx
      Left = 254
      Top = 25
      Width = 120
      Height = 22
