unit FrmMantenimientoImpuestos01;
...
type
  TFormMantenimientoImpuestos01 = class(TForm)
    pnlTitulo: TRzPanel;
...
var
  FormMantenimientoImpuestos01: TFormMantenimientoImpuestos01;
...
uses
  uSistema, ufunciones, uDL_TB_IMPUESTOS, BS_DBConexion,
  FrmImpuestos01, FrmMensaje_Espera01, udmLenguajes;
...
var
  Forma01: TFormMantenimientoImpuestos01;

{$REGION 'Funciones Forma'}
procedure TFormMantenimientoImpuestos01.FormShow(Sender: TObject);
begin
  Forma01 := FormMantenimientoImpuestos01;

  InicializarForma;
end;

procedure TFormMantenimientoImpuestos01.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
  FinalizarForma;
end;

procedure TFormMantenimientoImpuestos01.FormKeyDown(Sender: TObject;
  var Key: Word; Shift: TShiftState);
begin
  KeyDownForma(Key, Shift);
end;

procedure TFormMantenimientoImpuestos01.chkTodoLista1Click(Sender: TObject);
begin
  MDLista_Todos(lvLista1, chkTodoLista1);
end;

procedure TFormMantenimientoImpuestos01.btnInsertarClick(Sender: TObject);
begin
  Insertar;
end;

procedure TFormMantenimientoImpuestos01.btnModificarClick(Sender: TObject);
begin
  Modificar(lvLista1);
end;

procedure TFormMantenimientoImpuestos01.btnEliminarClick(Sender: TObject);
begin
  Eliminar(lvLista1);
end;

procedure TFormMantenimientoImpuestos01.btnRefrescarClick(Sender: TObject);
begin
  Refrescar(lvLista1);
end;

procedure TFormMantenimientoImpuestos01.btnCerrarClick(Sender: TObject);
begin
  Cerrar;
end;

procedure TFormMantenimientoImpuestos01.edtBuscar_NombreInvokeSearch(
  Sender: TObject);
begin
...
begin
  ...
  begin
    ...
    FormImpuestos01._Opcion := 1;
    FormImpuestos01.ShowModal;
    if FormImpuestos01.Tag = 1 then
      btnRefrescar.Click;
...
begin
  ...
  begin
    ...
    begin
      ...
      if mId > 0 then
      begin
        FormImpuestos01._Id := mId;
        FormImpuestos01._Opcion := 2;
        FormImpuestos01.ShowModal;
        if FormImpuestos01.Tag = 1 then
          btnRefrescar.Click;
      end;
...
begin
  ...
  begin
    ...
    try
      ...
      LlenarlvLista1(lv, mBS_Impuestos.Dataset);
