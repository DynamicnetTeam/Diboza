unit FrmMantenimientoRecibosClientes01;
...
type
  TFormMantenimientoRecibosClientes01 = class(TForm)
    pnlTitulo: TRzPanel;
...
var
  FormMantenimientoRecibosClientes01: TFormMantenimientoRecibosClientes01;
...
uses
  ...
  FrmRecibosClientes01, FrmMensaje_Espera01, udmLenguajes;
...
var
  Forma01: TFormMantenimientoRecibosClientes01;

{$REGION 'Funciones Forma'}
procedure TFormMantenimientoRecibosClientes01.FormShow(Sender: TObject);
begin
  Forma01 := FormMantenimientoRecibosClientes01;

  InicializarForma;
end;

procedure TFormMantenimientoRecibosClientes01.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
  FinalizarForma;
end;

procedure TFormMantenimientoRecibosClientes01.FormKeyDown(Sender: TObject;
  var Key: Word; Shift: TShiftState);
begin
  KeyDownForma(Key, Shift);
end;

procedure TFormMantenimientoRecibosClientes01.btnInsertarClick(Sender: TObject);
begin
  Insertar;
end;

procedure TFormMantenimientoRecibosClientes01.btnModificarClick(
  Sender: TObject);
begin
  Modificar(lvLista1);
end;

procedure TFormMantenimientoRecibosClientes01.btnRefrescarClick(
  Sender: TObject);
begin
  Refrescar(lvLista1);
end;

procedure TFormMantenimientoRecibosClientes01.btnCerrarClick(Sender: TObject);
begin
  Cerrar;
end;

procedure TFormMantenimientoRecibosClientes01.edtBuscar_NumeroInvokeSearch(
  Sender: TObject);
begin
  Buscar_Numero(edtBuscar_Numero.Text, lvLista1);
end;

procedure TFormMantenimientoRecibosClientes01.lvLista1CustomDrawItem(
  ...
  begin
    ...
    begin
      ...
      if (mId > 0) and (mEstado > 0) and
        (mDocumento > 0) then
      begin
        FormRecibosClientes01._IdEstado := mEstado;
        FormRecibosClientes01._IdFormaPago := mFormaPago;
        FormRecibosClientes01._IdDocumento := mId;
        FormRecibosClientes01._Numero := mDocumento;
        FormRecibosClientes01.WindowState := wsMaximized;
        FormRecibosClientes01.ShowModal;
        btnRefrescar.Click;
      end;
