...
var
  FormProformas01: TFormProformas01;
...
uses
  uSistema, ufunciones, uDL_TB_PROFORMASENCABEZADO, BS_DBConexion,
  FrmMensaje_Espera01, uDL_TB_PRODUCTOS, uDL_TB_PROFORMASDETALLE,
  ...
  udmLenguajes, uAuxiliares;

{$R *.dfm}

type
  Clase_Tipo1 = TDL_TB_PROFORMASENCABEZADO;
  Clase_Tipo2 = TDL_TB_PROFORMASDETALLE;
...
procedure TFormProformas01.FormShow(Sender: TObject);
begin
  Forma01 := FormProformas01;

  InicializarForma;
end;

procedure TFormProformas01.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  FinalizarForma;
end;

procedure TFormProformas01.FormKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  KeyDownForma(Key, Shift);
end;

procedure TFormProformas01.btnNuevoClick(Sender: TObject);
begin
  Nuevo;
end;

procedure TFormProformas01.btnPagarClick(Sender: TObject);
begin
  Pagar_Data;
end;

procedure TFormProformas01.CambiarDetalle1Click(Sender: TObject);
begin
  CambiarDetalle;
end;

procedure TFormProformas01.btnAnularClick(Sender: TObject);
begin
  Anular_Data;
end;

procedure TFormProformas01.Imprimir1Click(Sender: TObject);
begin
  Imprimir_Data;
end;

procedure TFormProformas01.VistaPrevia1Click(Sender: TObject);
begin
  VistaPrevia;
end;

procedure TFormProformas01.btnCerrarClick(Sender: TObject);
begin
  Cerrar;
end;

procedure TFormProformas01.btnDescuentoMontoClick(Sender: TObject);
begin
  DescuentoMonto;
end;

procedure TFormProformas01.btnBuscar_ClientesClick(Sender: TObject);
begin
  FormMantenimientoClientes01.ShowModal;
  LlenarcbClientes(cbCliente);
end;

procedure TFormProformas01.btnBuscar_VendedoresClick(Sender: TObject);
begin
  FormMantenimientoVendedores01.ShowModal;
  LlenarcbVendedores(cbVendedor);
end;

procedure TFormProformas01.btnInsertarLineaClick(Sender: TObject);
begin
  Insertar_Detalle;
...
procedure TFormProformas01.btnEliminarLineaClick(Sender: TObject);
begin
  Eliminar_Detalle;
  if Global.CodigoBarrasDirecto = 0 then
    edtCodigoProducto.SetFocus;
...
procedure TFormProformas01.btnFacturarClick(Sender: TObject);
begin
  Facturar;
end;

procedure TFormProformas01.edtCodigoProductoExit(Sender: TObject);
begin
  Buscar_ProductoCodigo(edtCodigoProducto.Text);
end;

procedure TFormProformas01.edtCodigoBarrasExit(Sender: TObject);
begin
  Buscar_ProductoCodigoBarras(edtCodigoBarras.Text);
end;

procedure TFormProformas01.edtCodigoProductoRightButtonClick(Sender: TObject);
begin
...
procedure TFormProformas01.edtProductoNombreRightButtonClick(Sender: TObject);
begin
...
procedure TFormProformas01.cbClienteChange(Sender: TObject);
begin
...
procedure TFormProformas01.chkTodoLista1Click(Sender: TObject);
begin
...
procedure TFormProformas01.edtCodigoProductoKeyDown(Sender: TObject;
...
procedure TFormProformas01.edtCodigoBarrasKeyDown(Sender: TObject;
  var Key: Word; Shift: TShiftState);
begin
  if Key = VK_RETURN then
  begin
...
procedure TFormProformas01.edtCantidadKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  if Key = VK_RETURN then
  begin
...
begin
  ...
  begin
    ...
    try
      ...
      mNumero :=
        mDL_TB_CONSECUTIVOS.Obtener_Valor('', 'PROFORMAS',
      _Resultado, _ErrorM);
      if _Resultado = -1 then
        raise Exception.Create('');
      ...
      mDL_TB_CONSECUTIVOS := TDL_TB_CONSECUTIVOS.Create;
      mDL_TB_CONSECUTIVOS.Actualizar_Campo('', 'PROFORMAS', mNumero,
        _Resultado, _ErrorM);
      if _Resultado = -1 then
        raise Exception.Create('');
      mDL_TB_CONSECUTIVOS.Destroy;
...
begin
  ...
  begin
    ...
    try
      ...
      _AFACTURASCLIENTESDETALLEAux := TDL_TB_FACTURASCLIENTESDETALLE.Create;
