...
interface
uses
  uSistema, DL_DBConexion, FireDAC.Comp.Client, udmConnection;
...
begin
  try
    ...
    _MainConexion.Port :=
      Global.DB_Puerto;
    _MainConexion.Conectar(pDriver, _Resultado, _ErrorM, dmConnection.FDMainConnection);
  except
  end;
end;
...
begin
  try
    ...
    _LicenciaConexion.Conectar(pDriver, _Resultado, _ErrorM, dmConnection.FDLocalConnection);
  except
  end;
end;
...
begin
  try
    ...
    _ClienteConexion.Conectar(pDriver, _Resultado, _ErrorM, dmConnection.FDType3Connection);
  except
  end;
end;
