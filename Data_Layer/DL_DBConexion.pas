...
type
  ...
  public
    ...
    constructor Create;
    destructor Destroy;
    procedure Conectar(pDriver: string; var pResultado: Integer;
      var pErrorM: string; pTFDConnection: TFDConnection);
...
procedure TBS_DBConexion.Conectar(pDriver: string; var pResultado: Integer;
  var pErrorM: string; pTFDConnection: TFDConnection);
begin
  ...
  //dmConnection.FDMainConnection
  dmConnection.DB_Conectar(pTFDConnection,
