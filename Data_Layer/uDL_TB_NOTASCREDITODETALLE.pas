unit uDL_TB_NOTASCREDITODETALLE;
...
type
  ...
  TDL_TB_NOTASCREDITODETALLE = class
    Dataset: TDatasetMem;
    _ListaCampos: TStringList;
  const
    Tabla = 'TB_NOTASCREDITODETALLE';
    ClaseNombre = 'TDL_TB_NOTASCREDITODETALLE';
  public
    {$REGION 'Metodos'}
    constructor Create;
    destructor Destroy;
...
{ TDL_TB_NOTASCREDITODETALLE }

{$REGION 'Metodos'}
constructor TDL_TB_NOTASCREDITODETALLE.Create;
begin
  Dataset := TDatasetMem.Create(nil);
  with Dataset do
  begin
    FileName := 'TB_NOTASCREDITODETALLE';
    FieldDefs.Clear;
...
destructor TDL_TB_NOTASCREDITODETALLE.Destroy;
begin
  Dataset.Close;
  Dataset.Free;
  _ListaCampos.Free;
...
procedure TDL_TB_NOTASCREDITODETALLE.Consultar(var pResultado: Integer;
...
begin
  ...
  if Trim(pSelect) = '' then
    dmObjects.DB_TB_NOTASCREDITODETALLE_Consultar(dmObjects.FDQuery1, Dataset,
...
procedure TDL_TB_NOTASCREDITODETALLE.Insertar(var pResultado: Integer;
...
begin
  ...
  dmObjects.DB_TB_NOTASCREDITODETALLE_Insertar(dmObjects.FDQuery1, Dataset, ClaseNombre,
    pResultado, pErrorM);
end;

procedure TDL_TB_NOTASCREDITODETALLE.Modificar(pWhere: string;
...
begin
  ...
  if Trim(pWhere) <> '' then
    mWhere := 'Where '+ pWhere;
  dmObjects.DB_TB_NOTASCREDITODETALLE_Modificar(dmObjects.FDQuery1, Dataset, mWhere,
    ClaseNombre, pResultado, pErrorM);
end;

procedure TDL_TB_NOTASCREDITODETALLE.Eliminar(pWhere: string;
  var pResultado: Integer; var pErrorM: string; FTypeConection: TTypeConection);
var
  mWhere: string;
begin
  ...
  if Trim(pWhere) <> '' then
    mWhere := 'Where '+ pWhere;
  dmObjects.DB_TB_NOTASCREDITODETALLE_Eliminar(dmObjects.FDQuery1, mWhere, Tabla, ClaseNombre,
    pResultado, pErrorM);
end;

procedure TDL_TB_NOTASCREDITODETALLE.Limpiar_Tag;
begin
  dmObjects.DB_Limpiar_Tag(Dataset);
end;

function TDL_TB_NOTASCREDITODETALLE.Existe_Id(pWhere: string;
  var pResultado: Integer; var pErrorM: string;
...
begin
  ...
  if Trim(pWhere) <> '' then
    mWhere := 'Where '+ pWhere;
  Result :=
    dmObjects.DB_TB_NOTASCREDITODETALLE_Existe_Id(dmObjects.FDQuery1, mWhere, Tabla,
      ClaseNombre, pResultado, pErrorM);
end;

function TDL_TB_NOTASCREDITODETALLE.Obtener_Id(pWhere: string;
  var pResultado: Integer; var pErrorM: string;
...
begin
  ...
  if Trim(pWhere) <> '' then
    mWhere := 'Where '+ pWhere;
  Result :=
    dmObjects.DB_TB_NOTASCREDITODETALLE_Obtener_Id(dmObjects.FDQuery1, mWhere, Tabla,
      ClaseNombre, pResultado, pErrorM);
end;

function TDL_TB_NOTASCREDITODETALLE.Existe_Campo(pWhere, pCampo: string;
...
begin
  ...
  if Trim(pWhere) <> '' then
    mWhere := 'Where '+ pWhere;
  Result :=
    dmObjects.DB_TB_NOTASCREDITODETALLE_Existe_Campo(dmObjects.FDQuery1, mWhere, Tabla,
      pCampo, ClaseNombre, pResultado, pErrorM);
end;

function TDL_TB_NOTASCREDITODETALLE.Obtener_Valor(pWhere, pCampo: string;
  var pResultado: Integer; var pErrorM: string;
...
begin
  ...
  if Trim(pWhere) <> '' then
    mWhere := 'Where '+ pWhere;
  Result :=
    dmObjects.DB_TB_NOTASCREDITODETALLE_Obtener_Valor(dmObjects.FDQuery1, mWhere, Tabla,
      pCampo, ClaseNombre, pResultado, pErrorM);
end;

procedure TDL_TB_NOTASCREDITODETALLE.Actualizar_Campo(pWhere, pCampo: string;
...
begin
  ...
  if Trim(pWhere) <> '' then
    mWhere := 'Where '+ pWhere;
  dmObjects.DB_TB_NOTASCREDITODETALLE_Actualizar_Campo(dmObjects.FDQuery1, mWhere, Tabla,
    pCampo, pValor, ClaseNombre, pResultado, pErrorM);
end;

procedure TDL_TB_NOTASCREDITODETALLE.Sumar_Existencias(pWhere: string;
...
begin
  ...
  if Trim(pWhere) <> '' then
    mWhere := 'Where '+ pWhere;
  dmObjects.DB_TB_NOTASCREDITODETALLE_Sumar_Existencias(dmObjects.FDQuery1,
    mWhere, Tabla, d1, ClaseNombre, pResultado, pErrorM);
end;

procedure TDL_TB_NOTASCREDITODETALLE.Restar_Existencias(pWhere: string;
  d1: TFDMemTable; var pResultado: Integer; var pErrorM: string;
  FTypeConection: TTypeConection);
var
  mWhere: string;
begin
  ...
  if Trim(pWhere) <> '' then
    mWhere := 'Where '+ pWhere;
  dmObjects.DB_TB_NOTASCREDITODETALLE_Restar_Existencias(dmObjects.FDQuery1,
    mWhere, Tabla, d1, ClaseNombre, pResultado, pErrorM);
end;
{$ENDREGION}
